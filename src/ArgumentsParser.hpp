#ifndef ARGUMENTS_PARSRT
#define ARGUMENTS_PARSRT

#include <string>
#include <vector>

// A simple utility command line parser for parsing parameters send to the application
